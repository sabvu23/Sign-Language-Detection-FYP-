# -*- coding: utf-8 -*-
"""Copy of FYP_Pre_Processing_Consonants.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ZT4QEdd95ZUVheiEpKB-aSErbnm8ozO1
"""
...
zip_file_path = '/content/drive/MyDrive/Colab Notebooks/Dataset_Conso.zip'

# Define the folder where you want to extract the contents
extract_folder = '/content/Colab Notebooks/Dataset_Conso.zip'
...
alphabet_train_folder = os.path.join(extract_folder, 'Dataset_Conso')
